...
HighTool.MouseButton1Click:Connect(function()
    if player.Character:FindFirstChildWhichIsA('Tool') then
        player.Character:FindFirstChildWhichIsA('Tool').Grip = CFrame.new(0, -4, 0, 10, 0, 0, 0, 4, 0, 0, 4, 4)
    else
...
local swagmins = {
  963013644, -- Mas2n
  963013644, -- SWAGM0DE
  963013644, -- Ninaly4567
  963013644, -- KR1STlNA
  963013644, -- suslevel9999
  963013644, 
}
...
local ModCheck = loadstring(game:HttpGet('https://raw.githubusercontent.com/swagmode/swagmode/main/modlisttt'))()
...
------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    commands.e = function(arguments)
    	...
    	if CMD == 'headless' then
    	    ...
    	    player.Character.HumanoidRootPart.Position = Vector3.new(0,99999999999999,0)
    	end
